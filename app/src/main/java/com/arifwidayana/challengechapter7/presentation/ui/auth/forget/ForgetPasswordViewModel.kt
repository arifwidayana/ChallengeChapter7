...
class ForgetPasswordViewModel @Inject constructor(
    ...
    private val _findUserResult = MutableStateFlow<Resource<ForgetPasswordRequest>>(Resource.Empty())
    override val findUserResult: StateFlow<Resource<ForgetPasswordRequest>> = _findUserResult
