...
interface ForgetPasswordRepository {
    suspend fun findUser(forgetPasswordRequest: ForgetPasswordRequest): Flow<Resource<ForgetPasswordRequest>>
}

class ForgetPasswordRepositoryImpl @Inject constructor(
    private val localDataSource: LocalDataSource
): ForgetPasswordRepository, BaseRepository() {
    override suspend fun findUser(forgetPasswordRequest: ForgetPasswordRequest): Flow<Resource<ForgetPasswordRequest>> = flow {
